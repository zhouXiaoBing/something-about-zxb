//
//  ScrollerViewForProduct.m
//  vitagou
//
//  Created by Mac on 2017/7/18.
//  Copyright © 2017年 Vitagou. All rights reserved.
// 搞清楚第一次进来的时候，谁最先调用updatePageScrollerView。。。。。

#import "ScrollerViewForProduct.h"
static  NSInteger MaxImageViewCount = 3;//耿局详情有多少图片来决定
@interface ScrollerViewForProduct ()<UIScrollViewDelegate>
...
@implementation ScrollerViewForProduct


//static NSUInteger *MaxImageViewCount;

+(instancetype)pageScroller:(NSArray<NSString *> *)images placeHolderImage:(UIImage *)placeHolderImage{
    NSLog(@"pageScroller");
    ScrollerViewForProduct *pageView = [[self alloc]init];
    pageView.images = images;
    pageView.placeImage = placeHolderImage;
//    pageView.images_ = images;
//    MaxImageViewCount = images.count;
