...
//    _picNum.font =  [UIFont systemFontOfSize:10];
...
////    _picItem = picItem;
//    
//    [_pciImageView sd_setImageWithURL:[NSURL URLWithString:[VITAGOUURL stringByAppendingString:picItem.images[0]]]];
...
//    NSString *image =[VITAGOUURL stringByAppendingString:img];
    NSLog(@"setImgimage %@",img);
//    NSLog(@"setImgimage %@",image);
    NSLog(@"setImg %@",[VITAGOUURL stringByAppendingString:img]);
    [_pciImageView sd_setImageWithURL:[NSURL URLWithString:[VITAGOUURL stringByAppendingString:img]]];
}
#pragma mark - 图片点击
- (void)tapImageView
{
