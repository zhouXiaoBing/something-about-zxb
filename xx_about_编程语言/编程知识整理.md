...
![image-20180424112652138](/var/folders/k0/zhv0tjnx2x51qkwsrffsqyc80000gn/T/abnerworks.Typora/image-20180424112652138.png)

从递归的定义中我们发现，一棵树是 N 个节点和 N - 1 条边的集合，其中的一个节点叫做根。每条边都将某个节点 连接到它的父亲，而除去根节点外每一个节点都有一个父亲。

![image-20180424113037297](/var/folders/k0/zhv0tjnx2x51qkwsrffsqyc80000gn/T/abnerworks.Typora/image-20180424113037297.png)
...
![image-20180424171821152](/var/folders/k0/zhv0tjnx2x51qkwsrffsqyc80000gn/T/abnerworks.Typora/image-20180424171821152.png)
...
算法的逻辑简单易懂。文件对象的名字和适当的跳格次数一起打印出来。如果是一个目录，那么以
