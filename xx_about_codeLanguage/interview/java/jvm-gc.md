...
JVM中的共划分为三个代：`新生代（Young Generation）`、`老年代（Old Generation）`和`持久代（Permanent Generation）`。其中持久代主要存放的是Java类的类信息，与垃圾收集要收集的Java对象关系不大。
  ...
  ![](/Users/Darin/Desktop/github/something-about-zxb/programKnowledgeSummary/jvm-gc-1.png)
...
![](/Users/Darin/Desktop/github/something-about-zxb/programKnowledgeSummary/hotspot-jvm-1.6-garbage-collector.png)
