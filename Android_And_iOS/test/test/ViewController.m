...
- (void)viewDidLoad {
    ...
    [self decrypt:[self encrypt:@"ABCDEFGHIJKLMNOPQRSTUVWXYZqwerty我" key:@"ytrewqABCDEFGHIJKLMNOPQRSTUVWXYZ"] key:@"ytrewqABCDEFGHIJKLMNOPQRSTUVWXYZ"];
}
...
- (NSString *)encrypt:(NSString *) txt key:(NSString *) key{
    ...
    NSLog(@"nhnum8 %d",nhnum%8);
    NSLog(@"knum8+16 %d",knum%8+16);
    NSLog(@"mdkey：%@",mdkey);
    ...
    txt = [[data base64EncodedStringWithOptions:0] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
...
- (NSString *)decrypt:(NSString *) txt key:(NSString *) key{
    ...
    NSString *strtmpDecode = [[[NSString alloc] initWithData:decodedData encoding:NSUTF8StringEncoding] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
//    NSString *strtmpDecodeTrim = [strtmpDecode stringByTrimmingCharactersInSet: [NSCharacterSet whitespaceAndNewlineCharacterSet]];
