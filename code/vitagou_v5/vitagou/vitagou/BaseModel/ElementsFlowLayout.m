...
@implementation ElementsFlowLayout
...
- (id<ElementsFlowLayoutDelegate>)delegate
{
    return (id<ElementsFlowLayoutDelegate>)self.collectionView.dataSource;
}
